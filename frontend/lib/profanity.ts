...
const profanitySet = new Set([
  ...
  "bakchod", "balatkar", "ballbag", "balls", "ballsack", "bastard", "beastial",
  "beastiality", "behanchod", "behenchod", "bellend", "betichod", "bevda",
  "bevakoof", "bhadva", "bhadve", "bhadwa", "bhenchod", "bhosada", "bhosda",
  "bhosdike",
  ...
  "dick", "dickhead", "dumbass", "dildo", "dildos", "dink", "dinks", "dirsa", "dlck",
